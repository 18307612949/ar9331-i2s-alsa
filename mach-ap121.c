...
#define AP121_I2C_GPIO_SDA              17
#define AP121_I2C_GPIO_SCL              1
...
static struct i2c_gpio_platform_data i2c_gpio_adapter_data = {
        .sda_pin = AP121_I2C_GPIO_SDA,
        .scl_pin = AP121_I2C_GPIO_SCL,
        .udelay = 5,
        .timeout = 100,
        .sda_is_open_drain = 1,
        .scl_is_open_drain = 1,
...
static struct platform_device ap121_i2c_device = {
        .name = "i2c-gpio",
        .id = 0,
        .dev = {
...
static struct i2c_board_info ap121_i2c_devs[] __initdata = {
        {
...
static void __init ap121_setup(void)
{
	...
	ath79_register_usb();
        ...
        platform_device_register(&ap121_i2c_device);

        i2c_register_board_info(0, ap121_i2c_devs,
                                ARRAY_SIZE(ap121_i2c_devs));
}
